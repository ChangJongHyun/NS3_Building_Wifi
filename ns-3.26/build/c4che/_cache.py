...
EXAMPLE_DIRECTORIES = ['tcp', 'traffic-control', 'udp-client-server', 'routing', 'udp', 'socket', 'naming', 'energy', 'ipv6', 'matrix-topology', 'error-model', 'tutorial', 'wireless', 'realtime', 'stats']
...
NS3_EXECUTABLE_PATH = ['/usr/ns-allinone-3.26/ns-3.26/build/src/fd-net-device', '/usr/ns-allinone-3.26/ns-3.26/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/usr/ns-allinone-3.26/ns-3.26/build']
...
VALGRIND_FOUND = True
VERSION = '3.26'
WITH_PYBINDGEN = '/usr/ns-allinone-3.26/pybindgen-0.17.0.post57+nga6376f2'
WL_SONAME_SUPPORTED = True
cfg_files = ['/usr/ns-allinone-3.26/ns-3.26/build/ns3/config-store-config.h', '/usr/ns-allinone-3.26/ns-3.26/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
